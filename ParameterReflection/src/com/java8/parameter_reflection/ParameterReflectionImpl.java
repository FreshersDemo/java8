package com.java8.parameter_reflection;
...
public class ParameterReflectionImpl 
{
	 ...
	 {  
	        ...
	        ParameterReflection param= new ParameterReflection();  
	        // instantiating Class class  
	        Class<? extends ParameterReflection> cls = param.getClass();  
	        // Getting declared methods inside the Calculate class  
	        Method[] method = cls.getDeclaredMethods(); 
	        // It returns array of methods  
